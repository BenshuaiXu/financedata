...
def normalize_time_and_price(daily_data, selected_stock):
...
def plot_normalized_overlay(normalized_days, selected_stock):
...
def day_pattern():
    ...
    if not intraday_data.empty:
        ...
        normalized_days = normalize_time_and_price(daily_data, selected_stock)

        # Step 3: Plot normalized overlay
        st.pyplot(plot_normalized_overlay(normalized_days, selected_stock))
